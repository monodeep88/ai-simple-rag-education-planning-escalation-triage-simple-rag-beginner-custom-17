...
The generated demo uses SQLite by default and is PostgreSQL-ready through `DATABASE_URL`. The schema focuses on storing explainable run history for **Education Planning Escalation Triage**.
