# Education Planning Escalation Triage

## Project Overview

Education Planning Escalation Triage is a complete full-stack AI project for **Simple RAG** at **Beginner** difficulty. It includes a FastAPI backend, a React frontend, sample documents, vector search with ChromaDB support, source citations, timeline logs, structured run storage, Docker files, and tests.

Education planning escalations require timely and effective triage to ensure students receive the necessary support. This project aims to develop a simple RAG system to categorize and prioritize escalations.
...
```text
ai-simple-rag-education-planning-escalation-triage-simple-rag-beginner-custom-17/
  backend/
app/
  main.py
  config.py
...
- Escalations must be categorized and prioritized within 2 hours
- High-priority escalations must be addressed within 1 hour
