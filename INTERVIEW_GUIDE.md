...
This is a Beginner **Simple RAG** project for **Education Planning Escalation Triage Simple RAG - Beginner Custom 17**. It demonstrates a React user interface, FastAPI backend, retrieval/workflow pipeline, stored run history, Docker setup, and tests.
