...
**Education Planning Escalation Triage** is not a static prompt demo. It is a runnable full-stack AI application for **Education Planning Escalation Triage Simple RAG - Beginner Custom 17** that demonstrates the core expectations of a **Simple RAG** project at **Beginner** difficulty.
